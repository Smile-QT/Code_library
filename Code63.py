...
def Threshold_based_contour_extraction(src_img_path: str, result_img_path: str, maxValue=255, adaptiveMethod=cv2.ADAPTIVE_THRESH_GAUSSIAN_C, thresholdType=cv2.THRESH_BINARY_INV, blockSize=3, C=5):
    """
    使用opencv库中的方法读取图片，
    基于阈值对图片进行轮廓提取
