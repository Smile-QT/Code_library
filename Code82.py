...
if __name__ == '__main__':
    ...
    filePath = r"C:/YXL/lijiawen/reptile/shipingzimu/xiaziashiping/Data/xinnongrenjihua02.xlsx"
    ...
    for path_i in range(1, len(first_col_values)):
        url_qizhongyigedizhi = first_col_values[path_i]
        headers = {
            # 用户信息, 常用于检测是否登陆
        ...
        try:
            video_url = main(url_qizhongyigedizhi)
        except:
            continue
        # 保存数据
        ...
        file_path01 = os.path.join('C:/YXL/lijiawen/reptile/shipingzimu/xiaziashiping/Data/video', str(path_i) + '.MP4')
        print(path_i)
        with open(file_path01, mode='wb') as f:
            # 写入数据
